/*
 * @Author: your name
 * @Date: 2024-01-09 11:54:16
 * @LastEditTime : 2024-01-09 21:09:18
...
bool insertUser(CDBConn* pDBConn)
{
    ...
    if (stmt->Init(pDBConn->GetMysql(), strSql))
    {
        ...
        string strNick = "明明";// 花名
        string strDomain = "mingming";// 花名拼音
        string strName = "大明明";// 真名
        string strTel = "17826559999";// 手机号码
        string strEmail = "444444444@qq.com";// Email
        string strAvatar = "";// 头像
        string sign_info = "等风来";//个性签名
        string strPass = "123456"; //密码
        string strCompany = "XX大学"; //公司
        string strAddress = "深圳市龙华区"; //地址
...
bool updateUser(CDBConn* pDBConn)
{
    ...
    if (pDBConn)
    {
        ...
        int nStatus = 0; // 用户状态0 正常， 1 离职
        uint32_t nDeptId = 0;// 所属部门
        string strNick = "小小";// 花名
        string strDomain = "smallsmall";// 花名拼音
        string strName = "肖小小";// 真名
        string strTel = "17888888888";// 手机号码
        string strEmail = "666666666@qq.com";// Email
        string strAvatar = "";// 头像
